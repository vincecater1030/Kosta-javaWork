...
*/
	public String methodExam02_02(String aaa) {
		System.out.println(aaa +"바보");
		return aaa+"바보";
...
*/
	void methodExam02_03(int b , String aaa){
...
/*	
	...
	(구현부에서)하는일 : 첫번째 인수 곱하기 두번째인수 빼기 세번째인수 결과 출력
			     위의 결과를 리턴
*/
	protected double methodExam02_04(int c , double d, int e ) {
		double re =c*d-e;
