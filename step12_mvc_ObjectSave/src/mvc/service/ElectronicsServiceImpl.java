...
///////////////////////////////////////////////
	...
	public List<Electronics> selectSortByPrice() {
		 ...
		 * 
		 * @Override public int compare(Electronics a, Electronics b) {
		 * 
		...
		/*
		 * Collections.sort(sortList, (o1,o2) ->{ int result = (o1.getModelPrice() -
		 * o2.getModelPrice()) == 0 ? o1.getModelNo() - o2.getModelNo() :
	...
	/*
	 * @Override public List<Electronics> selectSortByPrice() { List<Electronics>
	 * sortList = new ArrayList<Electronics>(list);
	 * 
	 * Collections.sort(sortList , new Comparator<Electronics>() {
	 * 
	 * @Override public int compare(Electronics o1, Electronics o2) { //return
	 * o1.getModelPrice() - o2.getModelPrice(); //올림 //return o2.getModelPrice() -
	 * o1.getModelPrice();//내림
	 * 
	 * return (o1.getModelPrice() - o2.getModelPrice()==0) ? (o2.getModelNo() -
	 * o1.getModelNo()) : o1.getModelPrice() - o2.getModelPrice(); } } );
	 * 
	 * return sortList; }
	 */
